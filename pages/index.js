...
export default function Home() {
    return (
        <div className="flex justify-center min-h-screen bg-gradient-to-r from-[#cbd5e1] via-[#f8fafc] to-[#cbd5e1]">
            ...
            <div className="flex flex-col content-between w-11/12 min-h-screen pb-12 max-w-screen-3xl">
                ...
                <footer className="flex flex-col items-center justify-center">
                    ...
                    <div className="flex flex-col items-center justify-center text-center lg:w-4/12 ">
